...
This document describes the simulation state export and import functionality that allows saving and restoring the complete state of the Emergence Engine simulation.
